...
const tabs = [
  {
    title: "Geolocation",
    description:
      "Track your teams with pinpoint accuracy in real-time, anywhere in the field.",
    img: CarouselImg01,
  ...
  },
  {
    ...
    description:
      "Stay connected with instant updates on your team's status and safety.",
    img: CarouselImg02,
  ...
  },
  {
    ...
    description:
      "Built for teams of all sizes and agencies of all kind. Whether they be firefighters, infantry, or law enforcement",
    img: CarouselImg03,
          ...
          <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
            <div className="flex flex-col items-center justify-between pb-12 md:flex-row md:gap-8 md:pb-20 lg:gap-16">
              ...
              <div className="shrink-0 md:w-[500px] *:pl-7">
                ...
                <div className="relative mb-6 border-l [border-image:linear-gradient(to_bottom,transparent,--theme(--color-slate-400/.25),transparent)1] after:absolute after:left-0 after:top-0 after:h-4 after:w-px after:origin-bottom after:-translate-y-full after:animate-[shine_4s_ease-in-out_infinite] after:bg-[linear-gradient(180deg,transparent,--theme(--color-indigo-500/.5)_25%,--theme(--color-indigo-500)_50%,--theme(--color-indigo-500/.5)_75%,transparent)]">
                  <div className="mb-4">
                    <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-200),var(--color-gray-50),var(--color-indigo-300),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
                     An Advanced Mission Control Platform
                    </h2>
                    <p className="text-indigo-200/65">
                      Aegis integrates a command center containing key biometric data for every squadron members to empower command and leadership to execute their mission.
                    </p>
                  </div>
