    ...
    <div>
      ...
      >
        <div className="flex items-center justify-center">
          <svg
            className="mr-3 h-4 w-4 shrink-0 fill-gray-300"
            width={16}
            height={16}
            viewBox="0 0 16 16"
        ...
        <div className="ml-3 flex gap-1">
          <div className="flex h-6 w-6 items-center justify-center rounded-sm bg-gray-800 text-gray-300 shadow-xs">
            <svg
